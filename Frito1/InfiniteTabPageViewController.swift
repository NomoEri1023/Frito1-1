...
class InfiniteTabPageViewController: TabPageViewController {
    ...
    override init() {
        ...
        let vc1 = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "List2ViewController")
        ...
        var addButton: UIBarButtonItem = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.add, target: self, action: #selector(clickAddButton))

...
class List6ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource{
    
    @IBOutlet var myTableView6: UITableView!
    ...
    override func viewDidLoad() {
        ...
        myTableView6.register(UINib(nibName: "ListTableViewCell", bundle: nil), forCellReuseIdentifier: "cell")
        
        myTableView6.delegate = self
        myTableView6.dataSource = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // 一覧取得
        let realm = try! Realm()
        let shouhins = realm.objects(Shouhin.self).filter("category == %@", "加工食品")
        FoodItems = []

...
class List8ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource{
    
    @IBOutlet var myTableView8: UITableView!
    ...
    override func viewDidLoad() {
        ...
        myTableView8.register(UINib(nibName: "ListTableViewCell", bundle: nil), forCellReuseIdentifier: "cell")
        
        myTableView8.delegate = self
        myTableView8.dataSource = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // 一覧取得
        let realm = try! Realm()
        let shouhins = realm.objects(Shouhin.self).filter("category == %@", "調味料")
        FoodItems = []

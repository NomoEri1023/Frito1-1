...
class List9ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource{
    
    @IBOutlet var myTableView9: UITableView!
    ...
    override func viewDidLoad() {
        ...
        myTableView9.register(UINib(nibName: "ListTableViewCell", bundle: nil), forCellReuseIdentifier: "cell")
        
        myTableView9.delegate = self
        myTableView9.dataSource = self
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // 一覧取得
        let realm = try! Realm()
        let shouhins = realm.objects(Shouhin.self).filter("category == %@", "惣菜")
        FoodItems = []
